...
export default function InsertProduct() {
    ...
    const updateProduct = async (e) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/updateproduct/${id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    return (
        <div className='container-fluid p-5'>
            ...
            <div className="mt-3 mb-5 col-lg-6 col-md-6 col-12">
                <label htmlFor="product_barcode" className="form-label fs-4 fw-bold">Quantity</label>
                <input type="number" onChange={setBarcode} value={productBarcode} maxLength={12} className="form-control fs-5" id="product_barcode" placeholder="Enter Product Quantity" required />
            </div>
